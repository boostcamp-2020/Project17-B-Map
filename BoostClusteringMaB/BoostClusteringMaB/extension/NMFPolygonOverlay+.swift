...
extension NMFPolygonOverlay {
    ...
    /// PolygonOverlay 생성
    /// - Parameter points: 폴리곤으로 그려질 좌표값
    /// 폴리곤은 아래 설정으로 정함
    /// ```
    ...
    /// ```
    /// - Returns: 정해진 설정으로 반환된 PolygonOverlay
    ...
    /// PolygonOverlay 배열 생성
    /// - Parameter convexHulls: PolygonOverlay로 그려질 이중배열 좌표
    /// - Returns: PolygonOverlay 배열
